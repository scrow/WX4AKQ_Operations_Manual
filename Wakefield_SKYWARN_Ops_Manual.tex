...
\item Any one of the following:
  \begin{enumerate}
  \item Severe Thunderstorm Watch issued
  \item Tornado Watch issued
  \end{enumerate}
\emph{...plus} any one of the following:
  \begin{enumerate}
...
\item Any one of the following:
  \begin{enumerate}
  \item Winter Storm Watch issued
  \item Winter Storm Warning issued
  \end{enumerate}
\emph{...plus} any one of the following:
  \begin{enumerate}
  \item Forecast ice accumulation in excess of 0.10 inches
  \item Forecast snow/sleet accumulation in excess of 2.00 inches
  \end{enumerate}
\item Any one of the following:
  \begin{enumerate}
  \item \textbf{Particularly Dangerous Situation (PDS) Severe Thunderstorm Watch issued}
  \item \textbf{Particularly Dangerous Situation (PDS) Tornado Watch issued}
  \item \textbf{Tornado Warning issued.}\footnote{Depending on the overall weather situation, it may not be possible to activate SKYWARN for every tornado warning.  Some thunderstorms do prompt tornado warnings without any other watch products in effect, in which case SKYWARN would not already be active and may not even be in a ``standby'' status.  In this circumstance, Net Control Operators may self-activate, there could be a larger effort at activating a portion of the team to address the warning, or SKYWARN may not activate at all.  This is the nature of the beast, and there is no way to achieve activation for 100\% of tornado warnings.}
  \item Tropical storms and hurricanes -- both coastal and inland impacts are to be considered
  \item ``Spotter Activation Requested'' or similar verbiage in the Hazardous Weather Outlook (HWO)
  \item Any storms with a recent history of damage, with or without a watch/warning/advisory in effect –- usually at local discretion
  \item Upon receipt of an activation request from the National Weather Service
  \item At local Net Control, Net Manager, or Area Manager discretion
  \end{enumerate}
\end{enumerate}
...
\emph{...plus} any one of the following:
  \begin{enumerate}
  \item SPC Day 1 Convective Outlook Damaging Wind Risk at or above 45\%.
  \item SPC Day 1 Convective Outlook Severe Hail Risk at or above 45\%.
...
\item Any one of the following:
  ...
  \item \textbf{Particularly Dangerous Situation (PDS) Severe Thunderstorm Watch issued}
  \item \textbf{Particularly Dangerous Situation (PDS) Tornado Watch issued}
  \item Tropical storms and hurricanes -- for high-impact or ``direct strike'' situations
  \item Any storms with a recent history of damage, with or without a watch/warning/advisory in effect –- usually at local discretion
  \item Upon receipt of an activation request from the National Weather Service
  \item At local Net Control, Net Manager, or Area Manager discretion
  \end{enumerate}
...
It bears repeating that any formal request from the NWS for overnight support fully overrides any specific weather criteria stated here.
