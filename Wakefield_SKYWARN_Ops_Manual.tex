...
\begin{enumerate}
\item \tpteam members who volunteer to become SKYWARN Net Control Operators will be trained on SKYWARN policies and procedures, and will be expected to fully adhere.  This includes provisions requiring collection of reports from all areas (not just the locality the \tpteam usually serves).  See \nameref{sponsorship-of-nets} on page \pageref{sponsorship-of-nets} for further discussion.
...
\item Must have proof of completion of current FEMA IS.100, IS.200, IS.700, and IS.800 ICS/NIMS training, and any additional courses which may be required by NWS for operation out of the WFO.
...
\item Must have reliable access to the Internet and all potential frequencies and modes of communication within the assigned Operating Area (namely VHF FM, HF SSB, Winlink).
\item Must have proof of completion of current FEMA IS.100, IS.200, IS.700, and IS.800 ICS/NIMS training, and any additional courses which may be required by NWS for operation out of the WFO.
\end{enumerate}

\subsection{Selection of the Area Manager}

The SKYWARN Amateur Radio Coordinator may appoint one or more Area Managers to assist him in his/her role as Coordinator.  It is generally preferred to maintain a ratio of one Area Manager per Operating Area except in the case of newly formed Operating Areas or the promotion of a new Area Manager, in which case an additional, seasoned Area Manager may be assigned. 
...
Reserve NCO station requirements are the same as for regular Net Control Operators.
...
\item Must be familiar with Winlink messaging functions, including the XASTIR software.
\item Must have proof of completion of current FEMA IS.100, IS.200, IS.700, and IS.800 ICS/NIMS training, and any additional courses which may be required by NWS for operation out of the WFO.
\end{enumerate}
...
\item Effectively moving reports and radio traffic between the local SKYWARN nets and the WFO.
...
\item Passing traffic to and from other WFO's in the event of a communications outage.
\item Periodically running local SKYWARN nets in the absence of a Net Control Operator.
...
\item Getting SKYWARN involved in ARES training and drills.
...
\item Utilizing Winlink to retrieve log entries from the SKYWARN RMS.
\end{enumerate}
...
\item WPC Day 1 and Day 2 Quantitative Precipitation Forecast (QPF).
\item WPC Day 1 and Day 2 QPF Excessive Rainfall Discussion (QPFERD).
\item WPC winter precipitation products.
...
The RA should be distributed as early as possible and as often as needed while a severe weather threat exists.
...
\item If RMS is down or unavailable and the report must be relayed over the air to the NWS, only give the minimum information necessary to convey the report.  Do not give names or other specifics unless requested by NWS, and upon receiving such a request it should go by telephone or Winlink to avoid sending the information ``in the clear'' for the public to hear.
...
Winlink messaging is also a method of communicating with WX4AKQ and the WFO.
...
%% TODO:  Re-work this whole chapter!
