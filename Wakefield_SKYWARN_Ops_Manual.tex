...
\item Must have reliable access to the Internet and all potential frequencies and modes of communication within the assigned Operating Area (namely VHF FM, HF SSB, APRS).
\item Must have proof of completion of current FEMA IS.100, IS.200, IS.700, and IS.800 ICS/NIMS training, and any additional courses which may be required by NWS for operation out of the WFO.
\end{enumerate}
